        ...
        {selectedMedia && (
          ...
          >
            ...
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/80 hover:text-white z-10 bg-black/50 p-2 rounded-full"
            >
              <ChevronLeft size={24} />
            </button>
            <button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white/80 hover:text-white z-10 bg-black/50 p-2 rounded-full"
            >
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white">
              <div className="bg-black/50 backdrop-blur-sm rounded-lg p-4">
                ...
                <p className="text-sm text-white/80 mb-2">{selectedMedia.description}</p>
