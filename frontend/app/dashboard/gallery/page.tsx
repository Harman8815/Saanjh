        ...
        {filteredAlbums.map((album, index) => (
          ...
          >
            <Link href={`/dashboard/gallery/${album.id}`}>
              <div className="glass-card h-full overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer">
                {/* Cover Image */}
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <h3 className="text-xl font-emotional font-semibold text-text-primary mb-1 group-hover:text-primary transition-colors">
                        {album.title}
                      </h3>
