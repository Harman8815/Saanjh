      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-pink-400 mb-4">💍 Perfect Proposal</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Create unforgettable wedding proposals with our AI-powered generator. 
              Make your special moment truly magical and personalized.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Perfect Proposal. All rights reserved. Made with 💕 for lovebirds everywhere.
          </p>
        </div>
      </div>
    </footer>
