...
export default function Footer({ className = '' }: FooterProps) {
  ...
  return (
    <footer className={`glass-card mt-20 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-text-secondary mb-6 max-w-md leading-relaxed">
              Create unforgettable wedding moments with our AI-powered platform. 
              Make your special day truly magical and personalized.
            </p>
        ...
        >
          <p className="text-text-secondary">
            © {currentYear} Perfect Wedding. All rights reserved. Made with 💕 for lovebirds everywhere.
          </p>
        </motion.div>
      </div>
    </footer>
